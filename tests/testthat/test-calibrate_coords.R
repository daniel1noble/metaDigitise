...
### Refactored using with_mocked_bindings
# context("Check calibrate_coords...")

# testthat::test_that("Checking cal_coords..", {

#   testthat::with_mocked_bindings(
#     locator_mD = mockery::mock(
#       list(x = c(0, 0),   y = c(0, 100)),
#       list(x = c(0, 100), y = c(0,   0))
#     ),
#     .env = asNamespace("metaDigitise"),
...
#   testthat::with_mocked_bindings(
#     user_numeric = mockery::mock(1, 2, 3, 4),
#     .env = asNamespace("metaDigitise"),
#     testthat::expect_equal(
#       getVals(calpoints = data.frame(x = c(0, 0, 0, 100), y = c(0, 100, 0, 0), stringsAsFactors = TRUE)),
#       c(y1 = 1, y2 = 2, x1 = 3, x2 = 4),
...
#     # Mock metaDigitise internals
#     testthat::with_mocked_bindings(
#       internal_redraw          = function(...) "",
#       print_cal_instructions   = function(...) "",
#       cal_coords               = function(...) data.frame(x = c(0, 0, 0, 100), y = c(0, 100, 0, 0), stringsAsFactors = TRUE),
#       getVals                  = function(...) c(y1 = 1, y2 = 2, x1 = 3, x2 = 4),
#       logAxes                  = function(...) c(axes = "n"),
#       .env = asNamespace("metaDigitise"),

#       testthat::expect_equal(
#         user_calibrate(object = list(plot_type = "scatterplot")),
#         list(
#           calpoints  = data.frame(x = c(0, 0, 0, 100), y = c(0, 100, 0, 0), stringsAsFactors = TRUE),
#           point_vals = c(y1 = 1, y2 = 2, x1 = 3, x2 = 4),
#           log_axes   = c(axes = "n")
#         ),
#         info = "user_calibrate failed"
#       )
