...
Additionally there is another function, \fct{import\_metaDigitise}, that imports all digitised data from a directory, as either summarised or processed data. For example,

\begin{CodeChunk}
\begin{CodeInput}
>R import_metaDigitise(".../FiguresToExtract", summary=TRUE)
\end{CodeInput}
{\scriptsize
\begin{CodeOutput}
                  filename    group_id         variable   mean  error error_type n    r    sd   plot_type
