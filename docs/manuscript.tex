...
001_Anderson_1935_Fig1.png     setosa  Sepal Width (mm) 3.42 0.40 39 0.75 scatterplot
001_Anderson_1935_Fig1.png     setosa Sepal Length (mm) 5.00 0.38 39 0.75 scatterplot
001_Anderson_1935_Fig1.png versicolor  Sepal Width (mm) 2.77 0.32 44 0.52 scatterplot
001_Anderson_1935_Fig1.png versicolor Sepal Length (mm) 5.94 0.53 44 0.52 scatterplot
\end{CodeOutput}
\end{CodeChunk}
...
001_Anderson_1935_Fig1.png versicolor  Sepal Width (mm) 2.77 0.32 44 0.52 scatterplot
001_Anderson_1935_Fig1.png versicolor Sepal Length (mm) 5.94 0.53 44 0.52 scatterplot
     002_Doe_2013_Fig1.png     setosa      Sepal length 5.00 0.78 50   NA  mean_error
     002_Doe_2013_Fig1.png versicolor      Sepal length 5.93 1.05 50   NA  mean_error
     002_Doe_2013_Fig1.png viriginica      Sepal length 6.59 1.26 50   NA  mean_error
     003_Doe_2013_Fig3.png       <NA>      Sepal length 4.95 0.36 50   NA  histogram
\end{CodeOutput}
\end{CodeChunk}
